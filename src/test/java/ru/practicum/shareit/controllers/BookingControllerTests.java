...
public class BookingControllerTests {
    ...
    void testCreateBookingIllegalStartTime() throws Exception {
        bookingRequest2.setStart(moment.minusYears(3));
        mvc.perform(post("/bookings")
                        .content(mapper.writeValueAsString(bookingRequest2))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void testCreateBookingEndInPast() throws Exception {
        bookingRequest2.setEnd(moment.minusYears(3));
        mvc.perform(post("/bookings")
                        .content(mapper.writeValueAsString(bookingRequest2))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
